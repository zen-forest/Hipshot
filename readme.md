# Hipshot
Hipshot is a python tool for taking full page screenshots of websites either single-handedly, or with multiple URL's. I needed this and built my own tool after not being too satisfied with what exists. 
